#!/usr/bin/env python3
"""
Simplified script to generate game recap summaries and basic evaluation metrics.
This version focuses on the core functionality without heavy ML dependencies.
"""
...
def process_csv_file(input_file: str, output_file: str, endpoint_url: str, batch_size: int = 5):
    """Process the CSV file and generate summaries with evaluations"""
    
    # Initialize components
    generator = SimpleSummaryGenerator(endpoint_url)
    evaluator = SimpleNarrativeEvaluator()
    
    # Read the CSV file with proper handling of multiline content
