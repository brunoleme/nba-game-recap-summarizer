"""
Comprehensive integration tests for Phi-3.5-mini support.
This file tests the complete pipeline with both LLaMA and Phi models.
"""
...
class TestPhiIntegration:
    """Integration tests for Phi-3.5-mini support."""
...
"""
    ...
    def test_model_registry_supports_both_models(self):
        """Test that the model registry supports both LLaMA and Phi models."""
    ...
    def test_model_quantization_support(self):
        """Test that both models support quantization."""
    ...
    def test_model_peft_support(self):
        """Test that both models support PEFT methods."""
    ...
    def test_model_checkpoint_loading(self):
        """Test that both models support checkpoint loading."""
    ...
    def test_model_compatibility(self):
        """Test that both models are compatible with the same data format."""
        # Both models should work with the same data module
        with tempfile.TemporaryDirectory() as temp_dir:
            data_module = NBARecapDataModule(
                model_name="TinyLlama/TinyLlama-1.1B-Chat-v1.0",
            ...
            # Both models should be able to process the same data
            llama_model = LlamaRecapSummarizationModel(
                model_name="TinyLlama/TinyLlama-1.1B-Chat-v1.0",
                model_type="llama",
                use_quantization=False,
            ...
            # Both should be loaded and ready
    ...
    def test_model_architecture_differences(self):
        ...
        assert hasattr(llama_model, 'summarize_recap')
        assert hasattr(phi_model, 'summarize_recap')
        assert hasattr(llama_model, 'summarize_recaps')
        assert hasattr(phi_model, 'summarize_recaps')
        assert hasattr(llama_model, 'is_loaded')
        assert hasattr(phi_model, 'is_loaded')
