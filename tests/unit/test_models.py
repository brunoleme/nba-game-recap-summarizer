...
def test_load_model_from_checkpoint():
    ...
    with patch('nba_game_recap_summarizer.finetuning.models.llama_model.LlamaRecapSummarizationModel.load_model_from_checkpoint') as mock_load:
...
def test_phi_load_model_from_checkpoint():
    ...
    with patch('nba_game_recap_summarizer.finetuning.models.phi_model.PhiRecapSummarizationModel.load_model_from_checkpoint') as mock_load:
        mock_model = MagicMock()
        mock_model.is_loaded.return_value = True
        mock_load.return_value = mock_model
...
def test_mistral_load_model_from_checkpoint():
    ...
    with patch('nba_game_recap_summarizer.finetuning.models.mistral_model.MistralRecapSummarizationModel.load_model_from_checkpoint') as mock_load:
        mock_model = MagicMock()
        mock_model.is_loaded.return_value = True
        mock_load.return_value = mock_model
