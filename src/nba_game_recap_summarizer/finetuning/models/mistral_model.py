...
class MistralRecapSummarizationModel(BaseRecapSummarizationModel):
    """
    Mistral model for NBA game recap summarization.
    ...
    def __init__(self, model_name: str = "mistralai/Mistral-7B-Instruct-v0.3", model=None, tokenizer=None, **kwargs):
        # IMPORTANT: pass model_type="mistral" so Base can set flags/PEFT correctly
    ...
    def _initialize_model(
        ...
        **kwargs,
        ...
        # Mistral tokenizers often lack pad_token; set to eos for batching
        ...
        # Apply PEFT if configured (Base sets proper CAUSAL_LM + target_modules for Mistral)
    ...
    def summarize_recap(self, game_recap: str, max_length: Optional[int] = None) -> str:
        ...
        Uses Mistral's chat format for better performance.
        """
    ...
    def summarize_recaps(self, dataloader: DataLoader, max_length: Optional[int] = None) -> List[str]:
        ...
        logger.info("Generating recap summaries for batch (Mistral)")
        results: List[str] = []
        self.model.eval()
    ...
    def load_model_from_checkpoint(
        ...
        try:
            ...
            checkpoint = MistralRecapSummarizationModel.load_model_from_checkpoint(checkpoint_path)
            ...
            if "Unexpected key(s) in state_dict" in str(e) and "absmax" in str(e):
                ...
                try:
                    ...
                    model = MistralRecapSummarizationModel(
                        model_name=hparams.get("model_name", model_name or "mistralai/Mistral-7B-Instruct-v0.3"),
