...
from nba_game_recap_summarizer.api import inference  # Keeps import for packaging logic validation
...
def package_model(cfg: DictConfig):
    ...
    inference_src_path = os.path.abspath("src/nba_game_recap_summarizer/api/inference.py")
